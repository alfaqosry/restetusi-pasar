                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control form-control-sm" id="colFormLabelSm"
                                    placeholder="col-form-label-sm" autocomplete="username">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control form-control-lg" id="colFormLabelLg"
                                    placeholder="col-form-label-lg" autocomplete="username">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-pay">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active show" id="tab20">
                                    <div class="bg-danger-transparent-2 text-danger py-2 mb-4" role="alert">Please
