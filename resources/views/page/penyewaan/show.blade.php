                        ...
                        <div class="row row-sm">
                                        ...
                                        <div class="product-carousel">
                                            <div id="Slider" class="carousel slide border" data-bs-ride="false">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active"><img src="{{ asset($toko->foto) }}" alt="img" class="img-fluid mx-auto d-block">
                            ...
                            <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                <div class="mt-2 mb-4">
                                    ...
                                    <h3 class="mb-4"><span class="me-2 fw-bold fs-25 d-inline-flex">Rp. {{$toko->biaya_restetusi}} </span></span></h3>
