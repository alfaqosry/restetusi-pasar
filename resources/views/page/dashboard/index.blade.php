...
<body class="app sidebar-mini ltr light-mode">
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="{{asset('sash/assets/images/brand/logo-white.png')}}" class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{asset('sash/assets/images/brand/logo-dark.png')}}" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
    ...
    <script src="{{asset('sash/assets/plugins/p-scroll/perfect-scrollbar.j')}}s"></script>
    ...
    <!-- Custom-switcher -->
    <script src="{{asset('sash/assets/js/custom-swicher.j')}}s"></script>
