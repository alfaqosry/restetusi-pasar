    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('pedagang.index') }}"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Pedagang</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('sewatempat.index') }}"><i
                            class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Sewa Tempat</span></a>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide"
                        href="{{ route('transaction.index') }}"><i class="side-menu__icon fe fe-credit-card"></i><span
